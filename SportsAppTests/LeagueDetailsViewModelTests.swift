...
final class LeagueDetailsViewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        LeagueDetailsVM = LeagueDetailsViewModel(nwServic: MockNetwork(), sport: "football", league: Leagues(league_key: 159, league_name: "My League", country_key: 20, country_name: "Egypt"))
